...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v '#' $iclu'_ener' | awk '{print $2}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $3}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $4}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $5}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $6}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $7}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $8}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $9}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $10}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $11}' |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt
  grep -v '#' $iclu'_ener' | awk '{print $12}' |$WDIR/average.perl >>cluster_ener.txt
end
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_viol' | awk '{print $2}' |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt
  grep -v "#" $iclu'_viol' | awk '{print $3}' |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt
  grep -v "#" $iclu'_viol' | awk '{print $4}' |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt
  grep -v "#" $iclu'_viol' | awk '{print $5}' |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt
  grep -v "#" $iclu'_viol' | awk '{print $6}' |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt
  grep -v "#" $iclu'_viol' | awk '{print $7}' |$WDIR/average.perl >>cluster_viol.txt
end
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_haddock-score' | awk '{print $2}' |$WDIR/average.perl >>cluster_haddock-score.txt
end
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_bsa' | awk '{print $2}' |$WDIR/average.perl >>cluster_bsa.txt
end
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_dH' | awk '{print $2}' |$WDIR/average.perl >>cluster_dH.txt
end
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_Edesolv' | awk '{print $2}' |$WDIR/average.perl >>cluster_Edesolv.txt
end
#
...
_Eod_
  ...
  grep -v "#" $iclu'_rmsd' | awk '{if (NF == 2) print $2}' |$WDIR/average.perl >>cluster_rmsd.txt
end
#
...
if (-e i-RMSD.dat) then
  ...
  foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9])
    ...
    grep -v "#" $iclu'_rmsd-Emin' | awk '{if (NF == 2) print $2}' |$WDIR/average.perl >>cluster_rmsd-Emin.txt
  end
else
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v '#' $iclu'_ener' | awk '{print $2}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $3}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $4}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $5}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $6}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $7}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $8}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $9}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $10}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $11}' | head -$nmb |$WDIR/average.perl \
  | awk '{printf "%8.2f %8.2f ",$1,$2}'>>cluster_ener.txt_best$nmb
  grep -v '#' $iclu'_ener' | awk '{print $12}' | head -$nmb |$WDIR/average.perl >>cluster_ener.txt_best$nmb
end
#
# calculate average cluster violations
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_viol' | awk '{print $2}' | head -$nmb |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt_best$nmb
  grep -v "#" $iclu'_viol' | awk '{print $3}' | head -$nmb |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt_best$nmb
  grep -v "#" $iclu'_viol' | awk '{print $4}' | head -$nmb |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt_best$nmb
  grep -v "#" $iclu'_viol' | awk '{print $5}' | head -$nmb |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt_best$nmb
  grep -v "#" $iclu'_viol' | awk '{print $6}' | head -$nmb |$WDIR/average.perl \
   | awk '{printf "%8.2f %8.2f ",$1,$2}' >>cluster_viol.txt_best$nmb
  grep -v "#" $iclu'_viol' | awk '{print $7}' | head -$nmb |$WDIR/average.perl >>cluster_viol.txt_best$nmb
end
#
# calculate average cluster buried surface area
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_bsa' | awk '{print $2}' | head -$nmb |$WDIR/average.perl >>cluster_bsa.txt_best$nmb
end
#
# calculate average HADDOCK score
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_haddock-score' | awk '{print $2}' | head -$nmb |$WDIR/average.perl >>cluster_haddock-score.txt_best$nmb
end
#
# calculate average cluster binding energy
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_dH' | awk '{print $2}' | head -$nmb |$WDIR/average.perl >>cluster_dH.txt_best$nmb
end
#
# calculate average cluster desolvation energy
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_Edesolv' | awk '{print $2}' | head -$nmb |$WDIR/average.perl >>cluster_Edesolv.txt_best$nmb
end
#
# RMSD calculations only if PROFITDIR is defined
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.nam_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_rmsd' | awk '{if (NF == 2) print $2}' | head -$nmb |$WDIR/average.perl >>cluster_rmsd.txt_best$nmb
end
#
# calculate average cluster rmsd from lowest energy structure
#
...
foreach iclu (file.nam_clust[0-9] file.nam_clust[0-9][0-9] file.name_clust[0-9][0-9][0-9])
  ...
  grep -v "#" $iclu'_rmsd-Emin' | awk '{if (NF == 2) print $2}' | head -$nmb |$WDIR/average.perl >>cluster_rmsd-Emin.txt_best$nmb
end  
#
# Combine results in one file
# 
